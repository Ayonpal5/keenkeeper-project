      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
          <div className="bg-white rounded-lg shadow p-6 text-center">
            <p className="text-4xl font-bold text-gray-800">{totalInteractions}</p>
            <p className="text-gray-600 mt-2">Total Interactions</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 text-center border-b-4 border-blue-500">
            <p className="text-4xl font-bold text-blue-600">{callCount}</p>
            <p className="text-gray-600 mt-2">Calls</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 text-center border-b-4 border-green-500">
            <p className="text-4xl font-bold text-green-600">{textCount}</p>
            <p className="text-gray-600 mt-2">Texts</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 text-center border-b-4 border-purple-500">
            <p className="text-4xl font-bold text-purple-600">{videoCount}</p>
                ...
                <div key={friend.id} className="flex items-center justify-between p-4 border-b">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{friend.days_since_contact} days since contact</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-gray-800">{friendInteractions.length}</p>
